...
public class MarketBidCommand extends SubCommand {
    ...
    public MarketBidCommand(MarketService service, MarketEconomy economy, ViewGuide guide, TaskHandler handler) {
    ...
    protected boolean execute(CommandSender sender, String arg1, String arg2) {
        ...
        handler.putTasks(GlobalMarket.TASK_MARKET, new TaskBid(player.getName(), service, economy, guide, id, num));
        return true;
    }
